// Built-in Clash Meta V3 rule template from miaomiaowu
export default `mode: rule
dns:
  enable: true
...
rule-providers:
  Custom_Direct_Domain:
    type: http
    behavior: domain
    url: https://testingcf.jsdelivr.net/gh/iluobei/Custom_OpenClash_Rules@main/rule/Custom_Direct_Domain.yaml
    path: ./providers/Custom_Direct_Domain.yaml
    interval: 28800
  Custom_Direct_Classical_IP:
    type: http
    behavior: classical
    url: https://testingcf.jsdelivr.net/gh/iluobei/Custom_OpenClash_Rules@main/rule/Custom_Direct_Classical_IP.yaml
    path: ./providers/Custom_Direct_Classical_IP.yaml
    interval: 28800
  Custom_Proxy_Domain:
    type: http
    behavior: domain
    url: https://testingcf.jsdelivr.net/gh/iluobei/Custom_OpenClash_Rules@main/rule/Custom_Proxy_Domain.yaml
    path: ./providers/Custom_Proxy_Domain.yaml
    interval: 28800
  Custom_Proxy_Classical_IP:
    type: http
    behavior: classical
    url: https://testingcf.jsdelivr.net/gh/iluobei/Custom_OpenClash_Rules@main/rule/Custom_Proxy_Classical_IP.yaml
