...
export const translations = {
  'zh-CN': {
    ...
    balanced: '均衡',
    comprehensive: '全面',
    clashTemplate: 'Clash 规则模板',
    clashTemplateNone: '不使用模板（原版规则选择）',
    clashTemplateHint: '选择妙妙屋风格完整 YAML 模板时，仅 Clash 链接生效；Sing-Box / Surge / Xray 仍用下方规则选择。',
    clashTemplateOverridesRules: '已选择 Clash 模板：下方规则选择对 Clash 链接不生效。',
    clashTemplateGroupV3: '妙妙屋原生 V3',
    clashTemplateGroupAethersailor: 'Aethersailor',
    clashTemplateGroupAcl4ssr: 'ACL4SSR',
  ...
  'en-US': {
    ...
    clashTemplate: 'Clash Rule Template',
    clashTemplateNone: 'No template (use rule selection)',
    clashTemplateHint: 'When a miaomiaowu-style full YAML template is selected, only the Clash link uses it. Sing-Box / Surge / Xray still use the rule selection below.',
    clashTemplateOverridesRules: 'Clash template selected: rule checkboxes do not apply to the Clash link.',
    clashTemplateGroupV3: 'Miaomiaowu native V3',
    clashTemplateGroupAethersailor: 'Aethersailor',
    clashTemplateGroupAcl4ssr: 'ACL4SSR',
  ...
  'fa': {
    ...
    balanced: 'متعادل',
    comprehensive: 'جامع',
    clashTemplate: 'قالب قوانین Clash',
    clashTemplateNone: 'بدون قالب (انتخاب قوانین)',
    clashTemplateHint: 'با انتخاب قالب YAML کامل، فقط لینک Clash از آن استفاده می‌کند. Sing-Box / Surge / Xray همچنان از انتخاب قوانین زیر استفاده می‌کنند.',
    clashTemplateOverridesRules: 'قالب Clash انتخاب شده: چک‌باکس قوانین روی لینک Clash اثر ندارد.',
    clashTemplateGroupV3: 'V3 بومی Miaomiaowu',
    clashTemplateGroupAethersailor: 'Aethersailor',
    clashTemplateGroupAcl4ssr: 'ACL4SSR',
  ...
  'ru': {
    ...
    clashTemplate: 'Шаблон правил Clash',
    clashTemplateNone: 'Без шаблона (выбор правил)',
    clashTemplateHint: 'При выборе полного YAML-шаблона он применяется только к ссылке Clash. Sing-Box / Surge / Xray по-прежнему используют выбор правил ниже.',
    clashTemplateOverridesRules: 'Выбран шаблон Clash: флажки правил не влияют на ссылку Clash.',
    clashTemplateGroupV3: 'Нативный V3 Miaomiaowu',
    clashTemplateGroupAethersailor: 'Aethersailor',
    clashTemplateGroupAcl4ssr: 'ACL4SSR',
